...
const quizArray = [
  ...
  {
    id: "6",
    question: "Which of the following us used to move an active cell to the “first column” on the current row?",
    options: ["Page up", "Ctrl+Home", "Page down", "Home"],
    correct: "Ctrl+Home",
  },
  {
    id: "7",
    question: "Each table appears as a “spreadsheet” that is called________________________. ",
  ...
  {
    id: "27",
    question: "In MS Excel, _____________function converts “decimal number to octal number”.",
    options: ["COVNERT", "DEC2BIN", "DEC2HEX", "DEC2OCT"],
    correct: "DEC2OCT",
  },
  {
    id: "28",
    question: "In MS Excel, _____________function returns a “random number”.",
    options: ["POWER", "MROUND", "RAND", "PI"],
    correct: "RAND",
  },
  {
    id: "29",
    question: "In MS Excel, ______________function returns the sum of given numbers.",
  ...
  {
    id: "40",
    question: "The Greater Than sign (>) exemplifies a/an _____ operator.",
  ...
  {
    id: "53",
    question: "11. Which tab in Excel is used when importing, querying, outlining and subtotaling the data placed into a worksheet‟s data list? ",
  ...
  {
    id: "66",
    question: "245. Except for the …… function, a formula with a logical function shows the word “TRUE” or “FALSE” as a result",
    options: ["IF", "AND", "OR", "NOT"],
    correct: "IF",
  },
  {
    id: "67",
    question: "237. In MS Excel, pivot chart may be inserted using first.",
